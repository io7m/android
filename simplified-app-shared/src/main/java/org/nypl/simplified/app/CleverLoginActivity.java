...
public final class CleverLoginActivity extends SimplifiedActivity implements AccountLoginListenerType {
  ...
  protected void onCreate(final Bundle state) {
    ...
    //TODO load external web URL. need to test this
  ...
  //TODO is this the correct life-cycle method to have this in?
  @Override
  protected void onResume() {
    super.onResume();

    //TODO
//    if (user has returned from clever login) { should it be done this way?
  ...
  public void onAccountLoginSuccess(
    ...
    //TODO where are the variables getting set to the account object? or were they already
    //assigned before the validation step began?
    //Is this just dismissing the activity at this point?
  ...
  public void onAccountLoginFailureDeviceActivationError(final String message) {
    ...
    final OptionType<Throwable> none = Option.none();
    this.onAccountLoginFailure(
      none, CleverLoginActivity.getDeviceActivationErrorMessage(0
