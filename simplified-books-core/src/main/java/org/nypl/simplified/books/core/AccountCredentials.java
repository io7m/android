...
public final class AccountCredentials {
  ...
  private OptionType<AccountAuthenticationAdobeClientToken> adobe_token;
  ...
  public AccountCredentials(
      ...
      final OptionType<AccountAuthenticationAdobeClientToken> in_adobe_token,
  ...
  public OptionType<AccountAuthenticationAdobeClientToken> getAdobeToken() {
   ...
   */
  public void setAdobeToken(final OptionType<AccountAuthenticationAdobeClientToken> in_adobe_token) {
    this.adobe_token = in_adobe_token;
  }
