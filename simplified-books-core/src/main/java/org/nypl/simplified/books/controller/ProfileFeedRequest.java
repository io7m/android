...
public abstract class ProfileFeedRequest {
  ...
  public abstract BooksFeedSelection feedSelection();
  ...
  public static abstract class Builder {
    ...
    public abstract Builder setFeedSelection(BooksFeedSelection x);
      ...
      final FeedFacetPseudoTitleProviderType title_provider)
  {
    ...
    b.setFeedSelection(BooksFeedSelection.BOOKS_FEED_LOANED);
    return b;
  }
}
